...
/**
 * One artifact — file or document — as a card: the library's and the
 * Hearth's unit of content. ONE tab stop per card (a stretched hit surface
 * behind the content) plus the action cluster layered above it; pinned
 * ribbon and live beacon are data-attribute treatments so app CSS can
