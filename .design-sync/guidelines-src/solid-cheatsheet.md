<!-- Copied verbatim from the solid repo (packages/solid/CHEATSHEET.md, branch next, solid-js 2.0.0-beta.17) by design-sync on 2026-07-14. In this design system, solid-js is window.AicolabUiSolid.Solid and @solidjs/web is window.AicolabUiSolid.SolidWeb. -->
